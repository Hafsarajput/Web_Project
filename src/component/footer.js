...
const App = () => {
  return (
    <div style={{ backgroundColor: '#222222', minHeight: '50vh', color: 'white', paddingTop: '50px' }}>
      ...
      <ul style={{ listStyle: 'none', padding: 0 }}>
        <li style={{ marginBottom: '15px' }}>Business</li>
        <li style={{ marginBottom: '15px' }}>Sports</li>
        <li style={{ marginBottom: '15px' }}>Foods</li>
        <li style={{ marginBottom: '15px' }}>Politics</li>
        <li style={{ marginBottom: '15px' }}>Celebrity</li>
      </ul>
          </Col>
      ...
      <Container>
        <Row className='align-items-center'>
          <Col xs={12} md={4}>
            <img src={Image2} alt='' style={{ maxWidth: '80px', height: 'auto' }} />
          </Col>
          <Col xs={12} md={8}>
            <p style={{ fontSize: '10px', marginBottom: '5px' }}>CULTURE . Jul 5th '22</p>
      ...
      <Container>
        <Row className='align-items-center'>
          <Col xs={12} md={4}>
            <img src={Image3} alt='' style={{ maxWidth: '80px', height: 'auto' }} />
          </Col>
          <Col xs={12} md={8}>
            <p style={{ fontSize: '10px', marginBottom: '5px' }}>CULTURE . Jul 5th '22</p>
